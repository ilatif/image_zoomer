(function($) {
  ...
  var zoom_canvas_container_name = "#zoom_canvas_container", zoom_canvas_name = "#zoom_canvas", temp_image_canvas_context;
    ...
    this.mouseenter(function(e) {
      ...
      if ($(zoom_canvas_container_name).length == 0) {
        ...
        zoom_canvas_container.mousemove(function(e) {
          zoom_image_mousemove(zoom_canvas_container, e, options, image, temp_image_canvas);
          return false;
  ...
  function zoom_image_mousemove(elem, e, options, image, temp_image_canvas) {
    ...
    _zoom_image(e, options, image, temp_image_canvas);
  }
  ...
  function _zoom_image(e, options, image, temp_image_canvas) {
